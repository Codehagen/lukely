...
export default function LogoCloudTwo() {
  ...
  return (
    <section className="border-t border-foreground/10">
      <div className="mx-auto max-w-6xl border-x border-foreground/10 px-3">
        <div className="border-x border-foreground/10 py-8 md:py-16">
          <div className="mx-auto mb-12 max-w-xl text-balance text-center md:mb-16">
            ...
            >
              Lukely brukes av ledende team innen{" "}
