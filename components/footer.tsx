                ...
                <div className="mx-auto max-w-5xl px-6">
                    <Card className="relative overflow-hidden p-12 shadow-lg md:px-32 md:py-20">
                        ...
                        <div className="relative text-center">
                            <h2 className="text-balance text-3xl font-semibold md:text-4xl">Kjør uforglemmelige sesongkampanjer med Lukely</h2>
                            <p className="text-muted-foreground mb-6 mt-4 text-balance">Bli med over 1000 merkevarer som henter nye abonnenter, øker inntektene og begeistrer kundene sine med interaktive opplevelser.</p>

                            <Button asChild>
                                <Link href="#">Planlegg julekampanjen</Link>
                            </Button>
                        </div>
                    </Card>
                </div>
                ...
                <div className="mx-auto max-w-5xl space-y-16 px-6">
                    <div className="grid gap-12 md:grid-cols-5">
                        <div className="space-y-6 md:col-span-2 md:space-y-12">
                            ...
                            <p className="text-muted-foreground text-balance text-sm">Lukely hjelper markedsføringsteam med å lansere interaktive sesongkampanjer og samle inn samtykkebasert førstepartsdata.</p>
                        </div>
                        ...
                        <div className="col-span-3 grid gap-6 sm:grid-cols-3">
                            ...
                            <div className="space-y-4">
                                <span className="block font-medium">Fellesskap</span>
                    ...
                    <div className="flex flex-wrap justify-between gap-4">
                        <span className="text-muted-foreground text-sm">© {new Date().getFullYear()} Lukely. Alle rettigheter forbeholdt.</span>
                        ...
                        <div className="ring-foreground/5 bg-card flex items-center gap-2 rounded-full border border-transparent py-1 pl-2 pr-4 shadow ring-1">
                            ...
                            <span className="text-sm">Alle systemer stabile</span>
                        </div>
                    </div>
                </div>
            </footer>
